...
const ReleaseDetails: React.FC<ReleaseDetailsProps> = ({ title, tracks, ownedBy }) => {
  return (
    <Box padding="10" maxWidth="800px" paddingTop="20" margin="auto" bg="white" boxShadow="xl" borderRadius="lg">
      ...
      <Heading as="h1" size="xl" textAlign="center" marginTop="4">
        {title}
      </Heading>
      ...
      {tracks && tracks.length > 0 ? (
        <Box>
          <Heading as="h2" size="lg" textAlign="center" mt="5" mb="2">
            Track listing
          </Heading>
          <List spacing={3}>
        ...
        <Text textAlign="center" color="gray.500" mt="5">No tracks available</Text>
      )}
    </Box>
  );
};
